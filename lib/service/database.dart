...
class DatabaseService {
  ...
  final CollectionReference sudokuCollection =
  ...
  Stream<List<Sudoku>> get sudokus {
    return sudokuCollection.snapshots().map(_sudokuListFromSnapshot);
  }

  // get database-user document stream
  Stream<UserData> get userData {
    return sudokuCollection.doc(uid).snapshots().map(_userDataFromSnapshot);
  }
}
